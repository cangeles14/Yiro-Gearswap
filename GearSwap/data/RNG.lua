...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'Annihilator', 'Fomalhaut', 'Armageddon', 'Gastraphetes'}
...
function init_gear_sets()
	...
	sets.precast.RA.Gastra.Flurry1 = {
		head="Orion Beret +3",
		body="Amini Caban +1",
		hands={ name="Carmine Fin. Ga. +1", augments={'Rng.Atk.+20','"Mag.Atk.Bns."+12','"Store TP"+6',}},
		legs={ name="Adhemar Kecks +1", augments={'AGI+12','Rng.Acc.+20','Rng.Atk.+20',}},
	...
	sets.precast.RA.Gastra.Flurry2 = {
		head="Orion Beret +3",
		body="Amini Caban +1",
		hands={ name="Carmine Fin. Ga. +1", augments={'Rng.Atk.+20','"Mag.Atk.Bns."+12','"Store TP"+6',}},
    ...
    sets.precast.WS['Apex Arrow'].Enmity = {}

    sets.precast.WS['Jishnu\'s Radiance'] = {}

    sets.precast.WS['Jishnu\'s Radiance'].Acc = {}

    sets.precast.WS['Jishnu\'s Radiance'].Enmity = {}
    ...
    sets.precast.WS["Coronach"].Enmity = {}
    ...
    sets.precast.WS['Evisceration'].Acc = sets.precast.WS

    sets.precast.WS['Rampage'] = sets.precast.WS
    sets.precast.WS['Rampage'].Acc = sets.precast.WS
    ...
    sets.midcast.RA.HighAcc = sets.midcast.RA
    ...
    sets.engaged.HighAcc = sets.engaged.MidAcc
    ...
    sets.engaged.DW.HighAcc = sets.engaged.MidAcc

    sets.engaged.DW.STP = sets.engaged.MidAcc

    -- 15% Magic Haste (67% DW to cap)
    sets.engaged.DW.LowHaste = sets.engaged

    sets.engaged.DW.LowAcc.LowHaste =sets.engaged
    sets.engaged.DW.MidAcc.LowHaste = sets.engaged

    sets.engaged.DW.HighAcc.LowHaste = sets.engaged
    sets.engaged.DW.STP.LowHaste = sets.engaged

    -- 30% Magic Haste (56% DW to cap)
    sets.engaged.DW.MidHaste = sets.engaged

    sets.engaged.DW.LowAcc.MidHaste = sets.engaged

    sets.engaged.DW.MidAcc.MidHaste = sets.engaged

    sets.engaged.DW.HighAcc.MidHaste = sets.engaged

    sets.engaged.DW.STP.MidHaste = sets.engaged

    -- 35% Magic Haste (51% DW to cap)
    sets.engaged.DW.HighHaste = sets.engaged

    sets.engaged.DW.LowAcc.HighHaste = sets.engaged

    sets.engaged.DW.MidAcc.HighHaste = sets.engaged

    sets.engaged.DW.HighAcc.HighHaste = sets.engaged

    sets.engaged.DW.STP.HighHaste = sets.engaged
    -- 45% Magic Haste (36% DW to cap)
    sets.engaged.DW.MaxHaste = sets.engaged

    sets.engaged.DW.LowAcc.MaxHaste = sets.engaged

    sets.engaged.DW.MidAcc.MaxHaste = sets.engaged

    sets.engaged.DW.HighAcc.MaxHaste = sets.engaged

    sets.engaged.DW.STP.MaxHaste = sets.engaged
    ...
    sets.Fomalhaut = {
		main="Perun +1", sub="Nusku Shield", range={ name="Fomalhaut", augments={'Path: A',}},
		ammo="Chrono Bullet",
	}
